...
module.exports = Object.assign(new nodeauth.AccessToken, {
	  ...
	  services: undefined,
	  accessTokenUrl: 'https://authn.sd00.worldcat.org/oauth2/accessToken?grant_type=code&code=auth_12345678&authenticatingInstitutionId=128807&contextInstitutionId=128807&redirect_uri=http://localhost:8000/request',
	  errorCode: null,
	  tokenType: 'bearer',
	  expiresIn: 899 
  });